...
$videos = explode('<div class="thumb jsNopeContainer thumbVideo">', $html);
...
//parsovani polozek
    ...
    $t1 = explode('<div data-icon="', $video);
    $t2 = explode('"', $t1[1]);
    $t3 = explode($t2[0].'":"', $kn);
    $t4 = explode('"', $t3[1]);
    $code = $t4[0];
	...
	$linktofinal= $HTTP_SCRIPT_ROOT."xLiveCZ/ulozto/uloztolive_link.php?key=".$key."&amp;code=".$code;
...
//parsovani polozek
	...
	$link = $HTTP_SCRIPT_ROOT."xLiveCZ/ulozto/uloztolive_link.php?url=".$link;
